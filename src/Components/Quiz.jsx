...
function Quiz({ studentEmail }) {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://student-grader-backend-production.up.railway.appquiz/start", { params: { email: studentEmail } })
      .then((response) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values, { setSubmitting }) => {
      ...
      axios
        .post(`https://student-grader-backend-production.up.railway.app/quiz/submit?email=${studentEmail}`, answers)
        .then(() => {
          setSubmitted(true);
  ...
  const fetchScore = () => {
    ...
    axios
      .get(`https://student-grader-backend-production.up.railway.app/students/score`, { params: { email: studentEmail } })
      .then((res) => {
        setScore(res.data);
      })
      .catch((err) => {
